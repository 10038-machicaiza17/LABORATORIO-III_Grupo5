...
<body>
    ...
    <div class="container-fluid page-paisheader d-flex flex-column align-items-center justify-content-center pt-0 pt-lg-5 mb-5">
        <h1 class="display-4 text-white mb-3 mt-0 mt-lg-5">JAPON</h1>
    ...
    if (isset($_GET['nombre'])) {
        ...
        $html .= '<p>Platos tipicos de diferentes regiones del pais del sol naciente!</p>';
        $html .= '</div>';
        ...
        foreach ($platosTipicos as $imagenPlato) {
            ...
            $html .= '<div class="bbb_name"><a href="#">Descripción</a></div>';
            $html .= '</div>';
            $html .= '</div>';
            $html .= '</div>';
            $html .= '</div>';
